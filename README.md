...
|-----------|-------------------|-------------|
| 🌐 Landing Page | [fastdb-landing](https://github.com/Mahavishnu-K/FastDB-Landing) | A React-based web application for signing up and getting started with `fastdb` and generating dev API key.|
...
<img src="https://github.com/Mahavishnu-K/FastDB/blob/main/client/public/FastDB_developer_console.png" alt="FastDB Developer Console" height="600px" width="auto"/>
