...
from .routes import query, schema, data, history, virtual_database, transaction , users as users_router, collaboration
...
api_router.include_router(collaboration.router, prefix="/databases")