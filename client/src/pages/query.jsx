            ...
            <div className="relative">
              ...
              {currentSQL && (
                <button
                  ...
                  className="absolute top-4 right-16 bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm flex items-center space-x-1"
                >
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-2">
              {queryHistory.map((item) => (
                <div key={item.id} className="bg-gray-700 rounded p-3 hover:bg-gray-600 transition-colors cursor-pointer">
                  <div className="text-sm text-white font-medium">{item.query}</div>
                  <div className="flex items-center justify-between mt-1">
                    <span className="text-xs text-gray-400">{item.timestamp}</span>
                    <span className={`text-xs px-2 py-1 rounded ${
                      item.type === 'SELECT' ? 'bg-blue-600 text-blue-100' :
                      item.type === 'CREATE' ? 'bg-green-600 text-green-100' :
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-2">
              {savedQueries.map((query) => (
                <div key={query.id} className="bg-gray-700 rounded p-3 hover:bg-gray-600 transition-colors cursor-pointer">
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <button 
                ...
                className="w-full text-left bg-gray-700 hover:bg-gray-600 text-white p-3 rounded transition-colors"
              >
                Show All Tables
              </button>
              <button 
